...
function readProductsTemplate(data, keywords){
    ...
    var read_products_html=`
        ...
        <table class='table table-bordered table-hover'>
            ...
            <tr>
                <th class='w-5-pct'>id заявки</th>
                <th class='w-25-pct'>id клиента</th>
                <th class='w-15-pct'>Дата создания заявки</th>
    ...
    $.each(data.records, function(key, val) {
        ...
        read_products_html+=`<tr>
            ...
            <td>
                ...
                <button class='binput bluecolor shadow btn btn-primary m-r-10px read-one-product-button' data-contract_id='` + val.contract_id  + `'>
                    Просмотреть
                </button>

                <!-- кнопка для изменения товара -->
                <button class='binput greycolor  btn-default shadow btn  m-r-10px update-product-button' data-contract_id='` + val.contract_id  + `'>
                     Редактировать
                </button>

                <!-- кнопка для удаления товара -->
                <button class='binput btn shadow btn-danger delete-product-button' data-contract_id='` + val.contract_id  + `'>
                     Удалить
                </button>
            </td>
        </tr>`;
