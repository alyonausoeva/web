    ...
    var read_products_html=`
        ...
        <table class='table table-bordered table-hover'>
            ...
            <tr>
                ...
                <th class='w-25-pct'>Сумма оплаты</th>
                <th class='w-15-pct'>Дата совершения оплаты </th>
    ...
    $.each(data.records, function(key, val) {
        ...
        read_products_html+=`<tr>
            ...
            <td>
                ...
                <button class='binput bluecolor shadow btn btn-primary m-r-10px read-one-product-button' data-pay_id='` + val.pay_id  + `'>
                    Просмотреть
                </button>

                <!-- кнопка для изменения товара -->
                <button class='binput greycolor  btn-default shadow btn  m-r-10px update-product-button' data-pay_id='` + val.pay_id  + `'>
                     Редактировать
                </button>
