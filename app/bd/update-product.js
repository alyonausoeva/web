jQuery(function($){
    ...
    $(document).on('click', '.update-product-button', function(){
        ...
        $.getJSON("http://web.std-237.ist.mospolytech.ru/api/product/read_one.php?id=" + id, function(data){
            ...
            $.getJSON("http://web.std-237.ist.mospolytech.ru/api/product/read.php", function(data){
...
// изменим title страницы
    ...
    $(document).on('submit', '#update-product-form', function(){
        ...
        $.ajax({
            url: "http://web.std-237.ist.mospolytech.ru/api/product/update.php",
            type : "POST",
