    ...
    var read_products_html=`
        ...
        <table class='table table-bordered table-hover'>
            ...
            <tr>
                ...
                <th class='w-25-pct'>Название базы данных</th>
                <th class='w-15-pct'>Объем </th>
    ...
    $.each(data.records, function(key, val) {
        ...
        read_products_html+=`<tr>
            ...
            <td>
                ...
                <button class='binput bluecolor shadow btn btn-primary m-r-10px read-one-product-button' data-bd_id='` + val.bd_id  + `'>
                    Просмотреть
                </button>

                <!-- кнопка для изменения товара -->
                <button class='binput greycolor  btn-default shadow btn  m-r-10px update-product-button' data-bd_id='` + val.bd_id  + `'>
                     Редактировать
                </button>

                <!-- кнопка для удаления товара -->
                <button class='binput btn shadow btn-danger delete-product-button' data-bd_id='` + val.bd_id  + `'>
                     Удалить
                </button>
            </td>
        </tr>`;
